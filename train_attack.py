...
from src.tools.saving import base_path_creator, attack_base_path_creator_train, prepend_attack_cache_path_creator
...
if __name__ == "__main__":
    ...
    if core_args.cache:
        cache_dir = prepend_attack_cache_path_creator(core_args, attack_args)
    ...
    attacker.train_process(data, attack_base_path, cache_dir)
